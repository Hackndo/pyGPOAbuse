...
class ScheduledTask:
    def __init__(self, gpo_type="computer", name="", mod_date="", description="", powershell=False, command="", old_value="", filteruser=0, filtercomputer=0, samaccount="None", user_sid="None",task_version="1.3", archivo="NOT_NEEDING"):
        self._type = gpo_type
